...
tb_gabriel <- xtable::xtable(bpca(gabriel1971),
                             ...
                             label='tbl_gabriel')
xtable::print.xtable(tb_gabriel)
@
...
xtable::print.xtable(tbl_rock_x)
@
...
xtable::print.xtable(xtable::xtable(bpca(rock),
